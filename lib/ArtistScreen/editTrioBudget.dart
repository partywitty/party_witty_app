...
class editTrioBudget extends StatefulWidget {
  String title,type,subcategoryId,venuePage;
  editTrioBudget({Key? key,
    required this.title,
    required this.type,
    required this.subcategoryId,
  required this.venuePage}) : super(key: key);

  @override
  State<editTrioBudget> createState() => _editTrioBudgetState();
}

class _editTrioBudgetState extends State<editTrioBudget> {
