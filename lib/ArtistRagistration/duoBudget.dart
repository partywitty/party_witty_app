...
class duoBudgetScreen extends StatefulWidget {
  String heading,type,subCategoryId;
  duoBudgetScreen({Key? key,required this.heading,required this.type,required this.subCategoryId}) : super(key: key);

  @override
  State<duoBudgetScreen> createState() => _duoBudgetScreenState();
}

class _duoBudgetScreenState extends State<duoBudgetScreen> {
      ...
      if (response.statusCode == 200) {
        ...
        if(responseDecode['error']){
          ...
          nextPage = responseDecode['data']['num_of_intrument'];
            ...
            if(nextPage == "3"){
              Navigator.push(context, MaterialPageRoute(builder: (context) => trioScreen(
